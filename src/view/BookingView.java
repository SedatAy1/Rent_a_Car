...
public class BookingView extends Layout {
    ...
    public BookingView(Car selectedCar, String strt_date, String fnsh_date) {
        ...
        this.fld_book_name.setText("İrem Kara Özdemir");
        this.fld_book_idno.setText("123123123");
        this.fld_book_mail.setText("irem@gmail.com");
        this.fld_book_mpno.setText("055555555");
        this.fld_book_prc.setText("2000");
        this.txta_book_note.setText("Not");
